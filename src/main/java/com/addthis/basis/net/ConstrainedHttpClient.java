...
public abstract class ConstrainedHttpClient {
    ...
    public ConstrainedHttpClient(int maxConcurrentRequests){
        ...
        /*
        // Gauge metric to display remaining concurrent connections
        Metrics.newGauge(this.getClass(), prefix + "concurrent-connections", new Gauge<Integer>() {
            @Override
    ...
    public int getCurrentRequests() {
        return semaphore.getMaxPermits() - semaphore.availablePermits();
    }
