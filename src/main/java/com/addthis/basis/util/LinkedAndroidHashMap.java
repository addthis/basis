 ...
 */
public class LinkedAndroidHashMap<K, V> extends AndroidHashMap<K, V> {
     ...
     */
    public LinkedAndroidHashMap(int initialCapacity) {
     ...
     */
    public LinkedAndroidHashMap(int initialCapacity, float loadFactor) {
     ...
     */
    public LinkedAndroidHashMap(Map<? extends K, ? extends V> map) {
    ...
    private abstract class LinkedHashIterator<T> implements Iterator<T> {
        ...
        public final void remove() {
            ...
            LinkedAndroidHashMap.this.remove(lastReturned.key);
            lastReturned = null;
