...
/**
 * LinkedHashMap is an implementation of {@link java.util.Map} that guarantees iteration order.
 ...
 */
public class AppendLinkedAndroidHashMap<K, V> extends AndroidHashMap<K, V> {
    ...
    private transient LinkedEntry<K, V> tail;
    ...
    /**
     * Constructs a new empty {@code LinkedAndroidHashMap} instance.
     */
    public AppendLinkedAndroidHashMap() {
        init();
        accessOrder = false;
    }

    /**
     * Constructs a new {@code LinkedAndroidHashMap} instance with the specified
     * capacity.
     *
     * @param initialCapacity the initial capacity of this map.
     * @throws IllegalArgumentException when the capacity is less than zero.
     */
    public AppendLinkedAndroidHashMap(int initialCapacity) {
     ...
     */
    public AppendLinkedAndroidHashMap(int initialCapacity, float loadFactor) {
     ...
     * @param loadFactor      the initial load factor.
     * @param accessOrder     {@code true} if the ordering should be done based on the last
    ...
    /**
     * Constructs a new {@code LinkedAndroidHashMap} instance containing the mappings
     * from the specified map. The order of the elements is preserved.
     *
     * @param map the mappings to add.
     */
    public AppendLinkedAndroidHashMap(Map<? extends K, ? extends V> map) {
    ...
    /**
     * LinkedEntry adds nxt/prv double-links to plain AndroidHashMapEntry.
     */
    static class LinkedEntry<K, V> extends AndroidHashMapEntry<K, V> {
         ...
         */
        LinkedEntry(K key, V value, int hash, AndroidHashMapEntry<K, V> next) {
    ...
    void addNewEntry(K key, V value, int hash, int index) {
        ...
        LinkedEntry<K, V> newTail = new LinkedEntry<K, V>(
                key, value, hash, table[index], header);
        table[index] = tail.nxt = newTail;
    }
    ...
    AndroidHashMapEntry<K, V> constructorNewEntry(
            K key, V value, int hash, AndroidHashMapEntry<K, V> next) {
        LinkedEntry<K, V> newTail
                = new LinkedEntry<K, V>(key, value, hash, next);
        tail.nxt = newTail;
        tail = newTail;
        return newTail;
    }
    ...
    public V get(Object key) {
        ...
        int hash = AndroidHashMap.secondaryHash(key);
    ...
    /**
     * This override is done for LinkedAndroidHashMap performance: iteration is cheaper
     * via LinkedAndroidHashMap nxt links.
     */
    @Override
    ...
    private abstract class LinkedHashIterator<T> implements Iterator<T> {
        ...
        public final void remove() {
            ...
            AppendLinkedAndroidHashMap.this.remove(lastReturned.key);
            lastReturned = null;
    ...
    private final class EntryIterator
            extends LinkedHashIterator<Entry<K, V>> {
