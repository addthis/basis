 ...
 * {@link com.addthis.basis.concurrentlinkedhashmap.MediatedEvictionConcurrentHashMap}
 * on a caller's thread and will not block other threads from operating on the map. An
 ...
 */
@ThreadSafe
public interface EvictionMediator<K, V> {
