...
/**
 * Linked list implementation of the {@link java.util.Deque} interface where the link
...
/**
 * An element that is linked on the {@link java.util.Deque}.
 */
